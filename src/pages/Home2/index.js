...
const Home2 = () => {
              ...
              <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src={imagen1} id="imagen" className="d-block w-100 " alt="..."/>
                  </div>
                  <div className="carousel-item">
                    <img src={imagen2} id="imagen3"className="d-block w-100" alt="..."/>
                  </div>
                  <div className="carousel-item">
                    <img src={imagen3} id="imagen4" className="d-block w-100 " alt="..."/>
                  </div>
                </div>
               ...
               <div className="todo">
                  <div className="contenedor2">
                      <div className="bene">
                          <div className="ben">
                          <h1 className="beneficios">LA MEJOR OPCION PARA TU<span> MASCOTA<span className="ta"></span></span>
                          </h1>
                      ...
                      <ul className="top">
                              <li className="top.1"> <span className="span1">1 COMPAÑIA </span>   <h1 className="formal">FORMAL</h1></li>
                              <li className="top.1"><span className="span1">1 COMUNIDAD </span><h1 className="formal">DE VETERINARIOS CAPACITADOS</h1></li>
                              <li className="top.1"><span className="span1">1 EQUIPO </span> <h1 className="formal">ENFOCADO EN CUIDAR A TU ENGREIDO</h1></li>
                      </ul>
                  ...
                  <div  className="container__picture">
                      ...
                      <div className="container__list">
                              <div className="container__item">
                                    ...
                                    <div className="tem">Registrate con nosotros y nos pondremos en contacto contigo</div>
                              </div>
                              <div className="container__item">
                                <div className="number">2</div>
                                <div  className="tem">Podras registrar una cita para definir el horario y el servicio que requieras.</div>
                              </div>
                              <div className="container__item">
                                <div className="number">3</div>
                                <div  className="tem">Recibiras un mensaje de confirmacion con la fecha y hora de la cita via email.</div>
                              </div>
                          
                              <div className="container__item">
                                <div className="number">4</div>
                                <div  className="tem">Podras calificar la atencion recibida dependiendo tu nivel de satisfacción</div>
                                </div>
                              </div>
                      </div> 
                </div>
  ...
  <div id="preguntas"className="accordion-item p-2">
    ...
    <div id="panelsStayOpen-collapseOne" className="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      ...
      Somos una empresa enfocada en el cuidado de animales, para lo cual brindamos las mejores medidas de seguridad activas en el mercado. Tu mascota estará segura con nosotros ya que contará con la atención de personal altamente calificado en practicas veterinarias    </div> 
    </div>
  </div>
  <div id="preguntas" className="accordion-item">
    <h2 className="accordion-header" id="panelsStayOpen-headingTwo">
      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
      ¿Cómo pido un cita para mi mascota?      </button>
    </h2>
    <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div className="accordion-body">
      El procedimiento es sencillo, dale click en el boton de registro, rellena los campos necesarios y reserva una cita con nostros, de esta manera los encargados de atencion al cliente podran comunicarse contigo       </div>
    </div>
  </div>
  <div id="preguntas" className="accordion-item">
    ...
    <div id="panelsStayOpen-collapseThree" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
      <div className="accordion-body">
      En nuestra empresa encontrarás una comunidad de veterinarios altamente capacitados en cuidado animal, olvidate de llamar y quedarte en espera, gestiona una cita con nosotros y te apoyaremos en el menor tiempo posible.      </div>
    </div>
  </div>
</div>
                ...
                <div className="consigue">
                    ...
                    <h1>Protege a tu mascota con nosotros y vive una experiencia <span>DIFERENTE </span> en la cual tu engreido estará protegido mientras se recupera.</h1>
                    <img src={imagen16} alt="" width="150px" height="150px" className="huella" />
                </div>
               ...
               <footer className="footer">
                <section className="footer__container container">
                    <nav className="nav nav--footer">   
                        ...
                        <ul className="nav__link nav__link--footer">
                            ...
                            <li className="nav__items">
                                <a href="#" className="nav__links"> PRODUCTOS </a>
                            </li>
                
                            
                            <li className="nav__items">
                                <a href="#" className="nav__links"> CONTACTANOS </a>
                            </li>
                        </ul>
                    </nav>
                    <form className="footer__form"  >
                        ...
                        <div className="footer__inputs">
                            <input type="tel" placeholder="Telefono:" className="footer__input"  pattern="[0-9]{9}"/>
                            <input type="submit" value="Contactate" className="footer__submit"/>
                        </div>
                    </form>
                </section>
                ...
                <section className="footer__copy container">
                    <div className="footer__social">
                        <a href="https://www.facebook.com/ToqueMagicoLima/" className="footer_icons"><img src={imagen17} className="footer__img" alt=""/></a>
                        <a href="https://wa.link/xg3zpt" className="footer_icons"><img src={imagen18} className="footer__img" alt=""/></a>
                        <a href="#" className="footer_icons"><img src={imagen19} className="footer__img" alt=""/></a>
        
                    </div>
                    <h3 className="footer__copyright">Derechos Reservados &copy;SAFETY CAN</h3>
                </section>
